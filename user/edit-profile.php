              ...
              <div class="row">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    ...
                    <div style="background-color: #398439;border-color: #255625;color: white">
                      <i><h4 style="font-size:20px;display: inline-block; padding:5px;border:3px solid transparent;
                      font-weight: bold;"&nbsp;>Verification Done ?</h4></i><img src="../img/tick.jpg" width="20px" height="20px">&nbsp;
                      <input type="radio"  name="Yes" value="Yes">
                      <label for="male">Yes</label>
                      <input type="radio"  name="No" value="No">
                      <label for="female">No</label>&nbsp;
                      <input style=" margin-left:40px;font-weight:bold;color: black;"type="submit" name="Verify" value="Submit">
                    </div>
                </div>
              </div>
              <?php
